...
FMR_GC_AT = [74.83, 58.97, 45.67, 39.74]
FMR_GC_AT_1 = [74.09, 57.03, 37.75,24.28]
...
ax.set_title('PGD-10 Attack', fontsize=28)
ax.set_xticks(x)
ax.set_xticklabels(epsilon, fontsize=25)
...
ax2.set_title('PGD-100 Attack', fontsize=28)
ax2.set_xticks(x)
ax2.set_xticklabels(epsilon, fontsize=25)
...
# 显示图形
plt.tight_layout()
plt.savefig('./plot/eplison_FMR_GC.pdf', format='pdf')
plt.show()

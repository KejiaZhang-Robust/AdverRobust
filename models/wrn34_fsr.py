...
class WideResNet(nn.Module):
    def __init__(self, depth=34, num_classes=10, widen_factor=10, dropRate=0.0, norm = False, mean = None, std = None):
        ...
        self.separation = Separation(size=(16, 32, 32), tau=self.tau)
        self.recalibration = Recalibration(size=(16, 32, 32))
        self.aux = nn.Sequential(nn.Linear(16, num_classes))
...
def WideResNet34_FSR(Num_class=10, Norm=False, norm_mean=None, norm_std=None):

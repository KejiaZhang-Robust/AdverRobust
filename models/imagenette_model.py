...
class WideResNet(nn.Module):
    def __init__(self, depth=34, num_classes=10, widen_factor=10, dropRate=0.0, norm = False, mean = None, std = None):
        ...
        self.fc = nn.Linear(nChannels[3]*25, self._num_classes)
        self.nChannels = nChannels[3]*25
...
class ResNet(nn.Module):
    ...
    def num_classes(self, value):
        self._num_classes = value
        self.linear = nn.Linear(512*self.block_expansion*25, self._num_classes).to(self.linear.weight.device)
